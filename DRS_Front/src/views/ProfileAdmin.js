...
<div className="flex justify-center items-center">
  ...
  <div className="py-6 px-3 mt-32 sm:mt-0 space-x-2">
    {/* If it's your profile */}
    {friendStatus === "self" && (
      <button
        onClick={handleEditProfile}
        className="uppercase font-bold shadow text-xs px-4 py-2 rounded bg-white border border-gray-300 hover:bg-gray-100 text-gray-800"
      >
